<template>
  <!-- <h1>{{ $route.params.id ? "Editar" : "Novo" }} Projeto</h1> -->
    ...
    <div class="col col-md-8 col-lg-6">
      <form>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" v-model="projeto.descricao" class="form-control" id="inputDescricao" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" v-model="projeto.dataInicial" class="form-control" id="inputDataInicial" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" v-model="projeto.dataFinal" class="form-control" id="inputDataFinal" />
          </div>
        </div>

        <div class="row mb-3">
          <label for="inputSituacaoProjeto" class="col-sm-2 col-form-label">Situação Projeto</label>
          <div class="col-sm-10">
        ...
        <div class="row mb-3">
          <label for="inputResumo" class="col-sm-2 col-form-label"
            >Resumo</label
          >
          <div class="col-sm-10">
        ...
        <div class="d-grid gap-2 d-flex justify-content-center">
          ...
          <router-link class="btn btn-secondary" :to="{ name: 'Projeto' }"
            >Voltar</router-link
          >
        </div>
      </form>
